...
void *counter_thread(void *arg) {
  ...
  /*
   * Until end_time, increment the counter each second. Instead of just
   * incrementing the counter, it sleeps for another second with the mutex
   * unlocked, to give monitor_thread a reasonable chance of running.
   */
...
void *monitor_thread(void *arg) {
  ...
  /*
   * Loop until end_time, checking the counter every three seconds.
   */
